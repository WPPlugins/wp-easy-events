...
<div class="inside">
<table class="form-table"><p class"lead"><?php _e('A person or organization attending the event.', 'wp-easy-events'); ?></p><tr>
...
<div class="accordion-section-content">
<div class="inside">
<table class="form-table"><p class"lead"><?php _e('Any planned public or social occasion.', 'wp-easy-events'); ?></p><tr>
...
<div class="accordion-section-content">
<div class="inside">
<table class="form-table"><p class"lead"><?php _e('Person or company that organizes events', 'wp-easy-events'); ?></p><tr>
<th><?php _e('Email', 'wp-easy-events'); ?></th>
<td><?php _e(' Email is filterable in the admin area. Email does not have a default value. ', 'wp-easy-events'); ?></td>
</tr><tr>
...
<div class="accordion-section-content">
<div class="inside">
<table class="form-table"><p class"lead"><?php _e('', 'wp-easy-events'); ?></p><tr>
