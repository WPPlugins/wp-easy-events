...
class Emd_Event_Organizer extends Emd_Entity {
	...
	public function add_menu_link() {
		add_submenu_page(null, __('Operations', 'wp-easy-events') , __('Operations', 'wp-easy-events') , 'manage_operations_emd_event_organizers', 'operations_emd_event_organizer', array(
			$this,
			'get_operations'
		));
	}
