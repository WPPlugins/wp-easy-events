...
if (!class_exists('WP_Easy_Events')):
	...
	final class WP_Easy_Events {
		...
		private function define_constants() {
			define('WP_EASY_EVENTS_VERSION', '3.1.0');
		...
		private function includes() {
			...
			if (!class_exists('EDD_SL_Plugin_Updater')) {
				require_once WP_EASY_EVENTS_PLUGIN_DIR . 'assets/ext/edd/EDD_SL_Plugin_Updater.php';
			}
			if (!class_exists('Emd_License')) {
				require_once WP_EASY_EVENTS_PLUGIN_DIR . 'includes/admin/class-emd-license.php';
			}
			if (!function_exists('emd_show_license_page')) {
				require_once WP_EASY_EVENTS_PLUGIN_DIR . 'includes/admin/license-functions.php';
			}
			//the rest
			...
			if (!class_exists('Zebra_Form')) {
				require_once WP_EASY_EVENTS_PLUGIN_DIR . '/assets/ext/zebraform/Zebra_Form.php';
			}
			if (!function_exists('emd_submit_form')) {
				require_once WP_EASY_EVENTS_PLUGIN_DIR . 'includes/form-functions.php';
			}
			if (!function_exists('emd_submit_ajax_form')) {
				require_once WP_EASY_EVENTS_PLUGIN_DIR . 'includes/form-ajax-functions.php';
			}
			...
			if (!function_exists('emd_form_register_settings')) {
				require_once WP_EASY_EVENTS_PLUGIN_DIR . 'includes/admin/settings-functions-forms.php';
			}
			...
			require_once WP_EASY_EVENTS_PLUGIN_DIR . 'includes/forms.php';
		...
		public function display_settings() {
			add_menu_page(__('Event Settings', $this->textdomain) , __('Event Settings', $this->textdomain) , 'manage_options', $this->app_name, array(
				$this,
			...
			add_submenu_page($this->app_name, __('Calendar', $this->textdomain) , __('Calendar', $this->textdomain) , 'manage_options', $this->app_name . '_calendar', array(
				$this,
